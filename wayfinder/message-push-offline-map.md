...
- [msg-push-05-frontend-permission](tickets/msg-push-05-frontend-permission.md): Banner on first `/chat` if `default` + `isPushSupported` → `requestPermission+subscribePush`, independent frontend half.
