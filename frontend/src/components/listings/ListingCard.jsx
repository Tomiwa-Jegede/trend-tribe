  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* ── Content ───────────────────────────────────── */}
        <div className="p-3 sm:p-4 flex flex-col gap-1.5 sm:gap-2 flex-1 min-w-0 overflow-hidden">
          <motion.span
          ...
          {/* Seller row — profile on its own line + Verified badge on its own line (prevents clipping on 2-col mobile) */}
          <div className="flex flex-col gap-1.5 mt-3 pt-3 border-t border-gray-100 min-w-0 overflow-hidden">
