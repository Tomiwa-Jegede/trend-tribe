        ...
        <div className="block md:hidden flex flex-col gap-3">
          {listings.map((l) => (
            ...
            >
              ...
              <p className="text-xs sm:text-sm text-gray-600 mb-1 grid grid-cols-[1fr_auto_auto] gap-1 items-center min-w-0 overflow-hidden">
                <span className="truncate min-w-0">@{l.seller?.username} · {l.category}</span>
                <span className="whitespace-nowrap flex-shrink-0 font-medium">♥ {l.favoriteCount ?? 0}</span>
                <span className="whitespace-nowrap flex-shrink-0 font-medium">👁 {l.contactViews ?? 0}</span>
              </p>
